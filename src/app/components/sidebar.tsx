...
export default function Sidebar({ active, user, expanded, setExpanded, sidebarRef } : { active: string, user: User | null, expanded: boolean, setExpanded: any, sidebarRef: any}) {
    ...
    let asideClasses = "fixed h-screen hidden z-40 w-24 flex-shrink-0 md:flex flex-col xl:w-64 border-r border:neutral-200 dark:border-neutral-800 bg-white dark:bg-black";

    if (expanded){
        asideClasses = "absolute z-50 h-screen fixed flex-shrink-0 flex flex-col w-64 border-r border:neutral-200 dark:border-neutral-800 bg-white dark:bg-black";
    }
